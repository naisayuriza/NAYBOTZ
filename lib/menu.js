...
├ _Ex = .Kata Aku cinta dia/nay_
├≽️ *.Logopornhub (teks1/teks2)*
├ _Ex : .Logopornhub rhis/nime
├≽️ *.Logoesport (teks)*
├ _Ex : .Logoesport rhis_(❌)
╰═══════════════
...
├ _Ex = .Jadwaltv Rcti_
├≽️ *.Lirik*
├ _Ex = .Lirik naisa - JanganMenyerah_
├≽️ *.Chord*
├ _Ex = .Chord Naisa - JanganMenyerah_
├≽️ *.Map (nama daerah)*
├ _Mini map_
╰═══════════════
